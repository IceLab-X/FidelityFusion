        ...
        for method in method_list:
            ...
            for _seed in [2,3,4]:
                ...
                for _high_fidelity_num in [4, 8, 16, 32]:
                    ...
                    xtr, Ytr, xte, Yte = generate_nonsubset_data(_data_name, x_dim = 1, min_value = 0, max_value = 1, num_points = 250, n_train = 100, n_test = 100,subset = True)
                    x_low = xtr[0]
                    y_low = Ytr[0]
                    ...
                    if method == 'AR':
                        ...
                        model = model_dic[method](fidelity_num=2,kernel_list = kernel_list, input_size = x_low.shape[1])
                ...
                path_csv = os.path.join('Experiments', 'AR_aa_try', 'exp_results', str(_data_name))
