...
## ⛏️Git submodule init
We use the [MiniGP](https://github.com/IceLab-X/MiniGP) library as the underlying layer of our code, and here we will use it as a submodule of the repository. Before you start using it, you need to execute the following three lines of code to update it
```
cd FidelityFusion
git submodule init
